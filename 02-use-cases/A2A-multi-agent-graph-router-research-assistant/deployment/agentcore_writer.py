"""AgentCore A2A entrypoint for the writer agent.

Deploys the writer/synthesizer agent as an A2A server on AgentCore Runtime.
AgentCore routes A2A protocol traffic to port 9000.

Usage (local):
    uvicorn deployment.agentcore_writer:app --host 0.0.0.0 --port 9000
"""
